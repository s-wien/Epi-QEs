...
This gives the same effect estimate of `r format(fixef(zika_lmer)["interaction"], digits=2, nsmall=2)` births per 1,000 population, with a 95% confidence interval of \[`r format(CI[1], digits=3, nsmall=3)`, `r format(CI[2], digits=3, nsmall=3)`\], indicating a statistically significant negative effect.
...
1.  How would you interpret this result for a collaborator or policy-maker?

2.  What do the three key assumptions mean in the context of this setting?
